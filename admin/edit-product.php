                              ...
                              <form action="code.php" method="POST" enctype="multipart/form-data">
                                 <div class="row">
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       <input type="text" required name="gender" value="<?= $data['gender']; ?>" placeholder="Enter size (eg:male)" class="form-control mb-2">
                                    </div>
                                    <div class="col-md-4">
                                       <label class="mb-0">Colour</label>
                                       <input type="text" required name="color" value="<?= $data['color']; ?>" placeholder="Enter colour (eg:black)" class="form-control mb-2">
                                    </div>
                                    <div class="col-md-4">
                                       <label class="mb-0">Size</label>
                                       <input type="text"  name="size" value="<?= $data['size']; ?>" placeholder="Enter size (eg:s)" class="form-control mb-2">
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12 text-end me-3 mt-3">
