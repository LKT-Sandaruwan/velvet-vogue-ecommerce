...
if (isset($_POST['add_category_btn'])) {
    ...
    if ($cate_query_run) {
        if (move_uploaded_file($_FILES['image']['tmp_name'], $path . '/' . $filename)) {
            ...
            redirect("add-category.php", "Failed to upload image");
        }
    } else {
    ...
    if ($name != "" && $slug != "" && $description != "") {
        $product_query = "INSERT INTO products (category_id, name, slug, small_description, description, original_price, selling_price, qty, gender, color, size, meta_keywords, status, trending, image) 
                          VALUES ('$category_id', '$name', '$slug', '$small_description', '$description', '$original_price', '$selling_price', '$qty', '$gender', '$color', '$size', '$meta_keywords', '$status', '$trending', '$filename')";
